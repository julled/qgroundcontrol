...
installer {
    ...
    AndroidBuild {
        ...
        isEmpty(_ANDROID_KEYSTORE_PASSWORD) {
            ...
            QMAKE_POST_LINK += && androiddeployqt --verbose --input android-QGroundControl-deployment-settings.json --output android-build --release --storepass $$(ANDROID_KEYSTORE_PASSWORD)
